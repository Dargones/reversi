...
public class StateAnalyzer implements Runnable {
    ...
    private static final int LOG_FQ = (int) Math.pow(2, 23);
    // frequency of the report. Report is printed then count % REPORT_FQ == 0
    private static final long DICT_MAX_SIZE = Runtime.getRuntime().maxMemory() / MAX / 8;
    ...
    // so I assume the actual memory usage to be 4 times as much. 
